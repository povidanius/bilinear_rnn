...
%For example, bilinear hashing \cite{Gong}, feed forward neural nets \cite{Daniusis}, SVM's \cite{Cai} in certain cases can be more efficient than conventional analogues.
%Linear projections plays fundamental role in many machine learning algorithms. 
